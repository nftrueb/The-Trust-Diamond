...
const credentialData = {
	...
	"address": "2500 Lake Cook Rd., Riverwoods, IL 60000"
};
...
async function run() {
	...
	console.log("Setting updateConfigsThreadId =", updateConfigsThreadId);
	const updateConfigs =
		new Promise(function (resolve, reject) {
	...
	console.log("Setting relThreadId =", relThreadId);
